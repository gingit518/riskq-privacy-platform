...
const fieldStyle = { display: "block", width: "100%", marginBottom: 16 } as const;

/** Company Profile, reskinned Batch 8 (PRD §5.12) — the last page in this UI
 * redesign pass, alongside Compliance, Connectors, and Regulations/scope.
 * No mockup exists for this page — direct token application, form itself
 * Card-wrapped. Data/action logic unchanged. */
